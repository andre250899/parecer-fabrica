    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        ...
        <div style={{ textAlign: "center" }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, margin: 0, letterSpacing: 2 }}>ANÁLISE TÉCNICA</h1>
          <div style={{ fontSize: 10, color: "#334155" }}>OS Nº {data.numeroOS || "—"}</div>
        </div>
        <div style={{ width: 90, textAlign: "right", fontSize: 10 }}>
          <strong>Sinistro:</strong><br />{data.sinistro || "—"}
        </div>
      </div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 6 }}>
        <tbody>
          <tr>
            ...
            <td style={cellStyle} colSpan={3}>{data.consumidorNome}</td>
          </tr>
          <tr>
            <td style={labelStyle}>Endereço:</td>
            <td style={cellStyle} colSpan={3}>{data.consumidorEndereco}</td>
          </tr>
          <tr>
            <td style={labelStyle}>Telefone:</td>
            <td style={cellStyle}>{data.consumidorTelefone}</td>
      ...
      <div style={headerBar}>PARECER TÉCNICO APÓS ANÁLISE DO PRODUTO</div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 6 }}>
        <tbody>
          ...
          <tr>
            <td style={labelStyle}>FORMA DE ATENDIMENTO:</td>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 8 }}>
        <PhotoBox src={data.cotacaoImg} label="COTAÇÃO DO ORÇAMENTO DA PEÇA (ATÉ 30 DIAS)" />
      ...
      <div style={{ marginTop: 30, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 30 }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 10 }}>Assinatura Técnico Responsável</div>
        </div>
        <div style={{ textAlign: "center" }}>
