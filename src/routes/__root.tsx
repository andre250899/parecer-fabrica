...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Vox Web" },
      ...
      { name: "apple-mobile-web-app-title", content: "Vox Web" },
      { name: "twitter:title", content: "Vox Web" },
      { name: "twitter:description", content: "Gere pareceres técnicos profissionais com 6 opções de design e exporte para PDF." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6927276a-2d7c-41dc-b746-9e228bce0dbf/id-preview-04796ef0--945432b2-6457-41a2-abc3-ae7491fb59f2.lovable.app-1784664128970.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6927276a-2d7c-41dc-b746-9e228bce0dbf/id-preview-04796ef0--945432b2-6457-41a2-abc3-ae7491fb59f2.lovable.app-1784664128970.png" },
    ],
    links: [
      {
        rel: "stylesheet",
